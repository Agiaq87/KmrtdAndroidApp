 ...
 * @since 0.7.0
 */
abstract class AbstractMRTDCardService : FileSystemCardService() {
    /**
     ...
     * 
     * @param keyId the chip's public key id (stored in DG14), `null` if none
     ...
     */
    abstract val wrapper: SecureMessagingWrapper?
     ...
     */
    abstract val maxReadBinaryLength: Int
}
