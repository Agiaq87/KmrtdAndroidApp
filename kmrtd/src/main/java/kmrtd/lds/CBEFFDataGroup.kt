...
abstract class CBEFFDataGroup : DataGroup {
    ...
    override fun readContent(inputStream: InputStream?) {
        ...
        val complexCBEFFInfo: ComplexCBEFFInfo<BiometricDataBlock> = decoder.decode(inputStream)
        val records: MutableList<CBEFFInfo<BiometricDataBlock?>> = complexCBEFFInfo.getSubRecords()
