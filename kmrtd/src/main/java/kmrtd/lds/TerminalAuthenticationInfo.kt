...
class TerminalAuthenticationInfo internal constructor(
   ...
   */@field:Transient private val efCVCA: ASN1Sequence?
     ...
     */
    constructor() : this(SecurityInfo.Companion.ID_TA, VERSION_1)
     ...
     */
    constructor(fileId: Short, shortFileId: Byte) : this(
        SecurityInfo.Companion.ID_TA,
        VERSION_1,
        constructEFCVCA(fileId, shortFileId)
    )
    ...
    private fun toProtocolOIDString(oid: String?): String? {
        if (SecurityInfo.Companion.ID_TA == oid) {
            return "id-TA"
        }
        if (SecurityInfo.Companion.ID_TA_RSA == oid) {
            return "id-TA-RSA"
        }
        if (SecurityInfo.Companion.ID_TA_RSA_V1_5_SHA_1 == oid) {
            return "id-TA-RSA-v1-5-SHA-1"
        }
        if (SecurityInfo.Companion.ID_TA_RSA_V1_5_SHA_256 == oid) {
            return "id-TA-RSA-v1-5-SHA-256"
        }
        if (SecurityInfo.Companion.ID_TA_RSA_PSS_SHA_1 == oid) {
            return "id-TA-RSA-PSS-SHA-1"
        }
        if (SecurityInfo.Companion.ID_TA_RSA_PSS_SHA_256 == oid) {
            return "id-TA-RSA-PSS-SHA-256"
        }
        if (SecurityInfo.Companion.ID_TA_ECDSA == oid) {
            return "id-TA-ECDSA"
        }
        if (SecurityInfo.Companion.ID_TA_ECDSA_SHA_1 == oid) {
            return "id-TA-ECDSA-SHA-1"
        }
        if (SecurityInfo.Companion.ID_TA_ECDSA_SHA_224 == oid) {
            return "id-TA-ECDSA-SHA-224"
        }
        if (SecurityInfo.Companion.ID_TA_ECDSA_SHA_256 == oid) {
    ...
    companion object {
        ...
        fun checkRequiredIdentifier(id: String?): Boolean {
            return SecurityInfo.Companion.ID_TA == id
        }
