...
class MRZInfo : AbstractLDSInfo {
    ...
    private constructor(
        ...
        require(
            isDocumentCodeConsistentWithDocumentType(
                documentType,
                documentCode
            )
        ) { "Wrong document code" }
        ...
        this.optionalData1 =
            if (optionalData1 == null) "" else trimTrailingFillerChars(optionalData1)
        this.optionalData2 =
            if (optionalData2 == null) null else trimTrailingFillerChars(optionalData2)
        checkDigit()
    }
    ...
    val secondaryIdentifierComponents: Array<String?>
         ...
         * @return first names
         */
        get() = secondaryIdentifier!!.split(" |<".toRegex()).dropLastWhile { it.isEmpty() }
            .toTypedArray()
    ...
    private fun writeObjectTD1(outputStream: OutputStream?) {
       ...
       */
            ...
            writeString(
                if (optionalData1 == null) "" else optionalData1,
                dataOut,
                15
    ...
    private fun readNameIdentifiers(mrzNameString: String) {
        ...
        primaryIdentifier =
            trimTrailingFillerChars(mrzNameString.substring(0, delimIndex)).replace("<", " ")
    ...
    private fun checkDigit() {
        ...
        if (documentType == DocumentType.TD3 && optionalData1!!.length < 15) {
            this.personalNumberCheckDigit = checkDigit(
                mrzFormat(optionalData1, 14),
                true
    ...
    companion object {
        ...
        private fun nameToString(
            ...
            val primaryComponents: Array<String?> =
                primaryIdentifier.split(" |<".toRegex()).dropLastWhile { it.isEmpty() }
                    .toTypedArray()
   ...
   */
        ...
        private fun isDocumentCodeConsistentWithDocumentType(
            ...
            when (documentType) {
                DocumentType.TD1, DocumentType.TD2 -> return documentCode.startsWith("C") || documentCode.startsWith(
                    "I"
