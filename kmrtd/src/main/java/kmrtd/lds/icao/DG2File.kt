...
class DG2File : CBEFFDataGroup {
    ...
    constructor(faceInfos: MutableList<FaceInfo?>?) : this(
    ...
    ) : super(LDSFile.Companion.EF_DG2_TAG, encodingType, biometricDataBlocks, false)
                ...
                decoders.put(
                    ...
                    object : BiometricDataBlockDecoder<BiometricDataBlock> {
                        ...
                        override fun decode(
                            ...
                            if (sbh != null && sbh.hasFormatType(StandardBiometricHeader.Companion.ISO_19794_FACE_IMAGE_FORMAT_TYPE_VALUE)) {
                                return FaceInfo(sbh, inputStream)
                            }
                            if (sbh != null && !sbh.hasFormatType(StandardBiometricHeader.Companion.ISO_39794_FACE_IMAGE_FORMAT_TYPE_VALUE)) {
