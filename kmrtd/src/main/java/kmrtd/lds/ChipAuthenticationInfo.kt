...
class ChipAuthenticationInfo @JvmOverloads constructor(
    ...
    override fun hashCode(): Int {
        return 3 + 11 * (if (oid == null) 0 else oid.hashCode()) + 61 * version + 1991 * (if (keyId == null) 111 else keyId.hashCode())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return oid == otherChipAuthenticationInfo.oid
    ...
    companion object {
        ...
        fun checkRequiredIdentifier(oid: String?): Boolean {
            return SecurityInfo.Companion.ID_CA_DH_3DES_CBC_CBC == oid
                    || SecurityInfo.Companion.ID_CA_ECDH_3DES_CBC_CBC == oid
                    || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_128 == oid
                    || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_192 == oid
                    || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_256 == oid
                    || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_128 == oid
                    || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_192 == oid
                    || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_256 == oid
        }
        ...
        fun toKeyAgreementAlgorithm(oid: String): String {
            ...
            if (SecurityInfo.Companion.ID_CA_DH_3DES_CBC_CBC == oid
                || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_128 == oid
                || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_192 == oid
                || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_256 == oid
            ) {
                return "DH"
            } else if (SecurityInfo.Companion.ID_CA_ECDH_3DES_CBC_CBC == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_128 == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_192 == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_256 == oid
            ) {
        ...
        fun toCipherAlgorithm(oid: String?): String {
            if (SecurityInfo.Companion.ID_CA_DH_3DES_CBC_CBC == oid
                ...
                return "DESede"
            } else if (SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_128 == oid
                || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_192 == oid
                || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_256 == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_128 == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_192 == oid
        ...
        fun toDigestAlgorithm(oid: String?): String {
            if (SecurityInfo.Companion.ID_CA_DH_3DES_CBC_CBC == oid
                ...
                return "SHA-1"
            } else if (SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_192 == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_192 == oid
                || SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_256 == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_256 == oid
            ) {
        ...
        fun toKeyLength(oid: String?): Int {
            if (SecurityInfo.Companion.ID_CA_DH_3DES_CBC_CBC == oid
                ...
                return 192
            } else if (SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_256 == oid
                || SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_256 == oid
            ) {
                return 256
            }
        ...
        private fun toProtocolOIDString(oid: String?): String? {
            ...
            if (SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_128 == oid) {
                return "id-CA-DH-AES-CBC-CMAC-128"
            }
            if (SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_192 == oid) {
                return "id-CA-DH-AES-CBC-CMAC-192"
            }
            if (SecurityInfo.Companion.ID_CA_DH_AES_CBC_CMAC_256 == oid) {
                return "id-CA-DH-AES-CBC-CMAC-256"
            }
            if (SecurityInfo.Companion.ID_CA_ECDH_3DES_CBC_CBC == oid) {
                return "id-CA-ECDH-3DES-CBC-CBC"
            }
            if (SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_128 == oid) {
                return "id-CA-ECDH-AES-CBC-CMAC-128"
            }
            if (SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_192 == oid) {
                return "id-CA-ECDH-AES-CBC-CMAC-192"
            }
            if (SecurityInfo.Companion.ID_CA_ECDH_AES_CBC_CMAC_256 == oid) {
