...
class FingerImageInfo : AbstractImageInfo {
    ...
    constructor(
        ...
        ImageInfo.Companion.TYPE_FINGER,
        width,
        height,
        imageBytes,
        imageLength.toLong(),
    ...
    companion object {
        ...
        /** Palm code, according to Table 6, 7.2.2, ISO 19794-4.  */ /* NOTE: in comment: max image area in sq mm, sq in, with in mm, in, length in mm, in */
        ...
        private fun toBiometricSubtype(position: Int): Int {
            when (position) {
                POSITION_UNKNOWN_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE
                POSITION_RIGHT_THUMB -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_THUMB
                POSITION_RIGHT_INDEX_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_POINTER_FINGER
                POSITION_RIGHT_MIDDLE_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_MIDDLE_FINGER
                POSITION_RIGHT_RING_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RING_FINGER
                POSITION_RIGHT_LITTLE_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LITTLE_FINGER
                POSITION_LEFT_THUMB -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_THUMB
                POSITION_LEFT_INDEX_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_POINTER_FINGER
                POSITION_LEFT_MIDDLE_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_MIDDLE_FINGER
                POSITION_LEFT_RING_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RING_FINGER
                POSITION_LEFT_LITTLE_FINGER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LITTLE_FINGER
                POSITION_PLAIN_RIGHT_FOUR_FINGERS -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_PLAIN_LEFT_FOUR_FINGERS -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_PLAIN_THUMBS -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_THUMB
                POSITION_UNKNOWN_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE
                POSITION_RIGHT_FULL_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_RIGHT_WRITER_S_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE
                POSITION_LEFT_FULL_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_LEFT_WRITER_S_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_RIGHT_LOWER_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_RIGHT_UPPER_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_LEFT_LOWER_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_LEFT_UPPER_PALM -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_RIGHT_OTHER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_LEFT_OTHER -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_RIGHT_INTERDIGITAL -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_RIGHT_THENAR -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_RIGHT_HYPOTHENAR -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_RIGHT
                POSITION_LEFT_INTERDIGITAL -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_LEFT_THENAR -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
                POSITION_LEFT_HYPOTHENAR -> return CBEFFInfo.BIOMETRIC_SUBTYPE_NONE or CBEFFInfo.BIOMETRIC_SUBTYPE_MASK_LEFT
