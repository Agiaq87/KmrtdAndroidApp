        ...
        get() {
            if (sbh == null) {
                ...
                val formatType = byteArrayOf(
                    ((StandardBiometricHeader.Companion.ISO_19794_FINGER_IMAGE_FORMAT_TYPE_VALUE and 0xFF00) shr 8).toByte(),
                    (StandardBiometricHeader.Companion.ISO_19794_FINGER_IMAGE_FORMAT_TYPE_VALUE and 0xFF).toByte()
                )
