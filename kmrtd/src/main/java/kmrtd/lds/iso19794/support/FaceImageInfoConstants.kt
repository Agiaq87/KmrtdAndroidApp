...
object FaceImageInfoConstants {
    ...
    const val FEATURE_FEATURES_ARE_SPECIFIED_FLAG: Int = 0x000001
    const val FEATURE_GLASSES_FLAG: Int = 0x000002
    const val FEATURE_MOUSTACHE_FLAG: Int = 0x000004
    const val FEATURE_BEARD_FLAG: Int = 0x000008
    const val FEATURE_TEETH_VISIBLE_FLAG: Int = 0x000010
    const val FEATURE_BLINK_FLAG: Int = 0x000020
    const val FEATURE_MOUTH_OPEN_FLAG: Int = 0x000040
    const val FEATURE_LEFT_EYE_PATCH_FLAG: Int = 0x000080
    const val FEATURE_RIGHT_EYE_PATCH: Int = 0x000100
    const val FEATURE_DARK_GLASSES: Int = 0x000200
    const val FEATURE_DISTORTING_MEDICAL_CONDITION: Int = 0x000400
