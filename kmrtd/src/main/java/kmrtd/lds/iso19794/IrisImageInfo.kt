...
class IrisImageInfo : AbstractImageInfo {
    ...
    internal constructor(
        ...
        imageFormat: Int
    ) : super(ImageInfo.Companion.TYPE_IRIS) {
    ...
    companion object {
        ...
        private fun getMimeTypeFromImageFormat(imageFormat: Int): String? {
            when (imageFormat) {
                IrisInfo.Companion.IMAGEFORMAT_MONO_RAW, IrisInfo.Companion.IMAGEFORMAT_RGB_RAW -> return ImageInfo.Companion.WSQ_MIME_TYPE
                IrisInfo.Companion.IMAGEFORMAT_MONO_JPEG, IrisInfo.Companion.IMAGEFORMAT_RGB_JPEG, IrisInfo.Companion.IMAGEFORMAT_MONO_JPEG_LS, IrisInfo.Companion.IMAGEFORMAT_RGB_JPEG_LS -> return ImageInfo.Companion.JPEG_MIME_TYPE
                IrisInfo.Companion.IMAGEFORMAT_MONO_JPEG2000, IrisInfo.Companion.IMAGEFORMAT_RGB_JPEG2000 -> return ImageInfo.Companion.JPEG2000_MIME_TYPE
                else -> return null
            }
        }
    }
