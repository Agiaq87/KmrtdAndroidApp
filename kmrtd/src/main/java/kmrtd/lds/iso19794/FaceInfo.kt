        ...
        if (fac0 != FORMAT_IDENTIFIER) {
            ...
            if (fac0 == 0x0000000C) {
                ...
                val imageInfo = FaceImageInfo(
                    ...
                    0, 0,
                    ByteArrayInputStream(bOut.toByteArray()), imageLength, IMAGE_DATA_TYPE_JPEG2000
                )
                add(imageInfo)
                return
            }
        ...
        get() {
            if (sbh == null) {
                ...
                val formatType = byteArrayOf(
                    ((StandardBiometricHeader.Companion.ISO_19794_FACE_IMAGE_FORMAT_TYPE_VALUE and 0xFF00) shr 8).toByte(),
                    (StandardBiometricHeader.Companion.ISO_19794_FACE_IMAGE_FORMAT_TYPE_VALUE and 0xFF).toByte()
                )
