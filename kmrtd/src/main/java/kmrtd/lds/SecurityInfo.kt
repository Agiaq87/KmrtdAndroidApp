    ...
    companion object {
        ...
        fun getInstance(obj: ASN1Encodable?): SecurityInfo? {
            try {
                ...
                if (ActiveAuthenticationInfo.Companion.checkRequiredIdentifier(oid)) {
                ...
                } else if (ChipAuthenticationInfo.Companion.checkRequiredIdentifier(oid)) {
                    val version = ASN1Integer.getInstance(requiredData).getValue().toInt()
                    if (optionalData == null) {
                ...
                } else if (TerminalAuthenticationInfo.Companion.checkRequiredIdentifier(oid)) {
                    val version = ASN1Integer.getInstance(requiredData).getValue().toInt()
                    if (optionalData == null) {
                ...
                } else if (PACEInfo.Companion.checkRequiredIdentifier(oid)) {
                    val version = ASN1Integer.getInstance(requiredData).getValue().toInt()
                    var parameterId = -1
                    if (optionalData != null) {
                ...
                } else if (PACEDomainParameterInfo.Companion.checkRequiredIdentifier(oid)) {
