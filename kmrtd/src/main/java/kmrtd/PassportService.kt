...
class PassportService(
    ...
    override fun doBAC(bacKey: AccessKeySpec?): BACResult {
        ...
        val bacResult =
            (BACProtocol(bacSender, this.maxTranceiveLength, shouldCheckMAC)).doBAC(bacKey)
   ...
   */
    ...
    override fun doAA(
        ...
        return (AAProtocol(aaSender, getWrapper())).doAA(
            publicKey,
            digestAlgorithm,
            signatureAlgorithm,
            challenge
    ...
    companion object {
        ...
        protected val APPLET_AID: ByteArray =
