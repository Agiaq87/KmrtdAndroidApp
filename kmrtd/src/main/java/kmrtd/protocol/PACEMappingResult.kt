...
abstract class PACEMappingResult(
    ...
    override fun hashCode(): Int {
        ...
        var result = 1
        result =
            prime * result + (if (ephemeralParameters == null) 0 else ephemeralParameters.hashCode())
        result = prime * result + pICCNonce.contentHashCode()
        result = prime * result + (if (staticParameters == null) 0 else staticParameters.hashCode())
        return result
    }
    ...
    companion object {
        private const val serialVersionUID = 2773111318950631118L
    }
}
