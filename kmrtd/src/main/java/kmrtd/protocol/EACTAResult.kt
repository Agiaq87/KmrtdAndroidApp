...
class EACTAResult(
    ...
    override fun hashCode(): Int {
        ...
        result =
            prime * result + (if (chipAuthenticationResult == null) 0 else chipAuthenticationResult.hashCode())
        result = prime * result + (if (documentNumber == null) 0 else documentNumber.hashCode())
        result =
            prime * result + (if (this.cVCertificates == null) 0 else cVCertificates.hashCode())
