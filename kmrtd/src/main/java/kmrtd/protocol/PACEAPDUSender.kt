...
class PACEAPDUSender(service: CardService?) : APDULevelPACECapable {
     ...
     */
        ...
        val refPublicKeyOrSecretKeyBytes = TLVUtil.wrapDO(
            0x83,
            byteArrayOf(refPublicKeyOrSecretKey.toByte())
        ) /* FIXME: define constant for 0x83 */
     ...
     */
        ...
        /* Tranceive APDU. */
        val capdu =
            CommandAPDU(ISO7816.CLA_ISO7816.toInt(), ISO7816.INS_MSE.toInt(), 0xC1, 0xA4, data)
    ...
    override fun sendGeneralAuthenticate(
        ...
        val capdu = CommandAPDU(
            ...
            INS_PACE_GENERAL_AUTHENTICATE.toInt(),
            0x00,
            0x00,
            commandData,
            le
